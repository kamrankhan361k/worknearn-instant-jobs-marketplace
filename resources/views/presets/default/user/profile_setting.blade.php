                        ...
                        <div class="row gy-4">
                                        ...
                                        <div class="profile_photo mb-2">
                                            ...
                                            <div class="photo_upload">
                                                ...
                                                <input type="file" name="image" class="upload_file"
                                                    id="file_upload" onchange="profileImg(this);">
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input--group">
                                        <input type="text" class="form--control" id="state"
                                            placeholder="Email Address" name="state"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text mobile-code bg--base text-white b-none">
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input--group">
                                        <input type="text" id="city" class="form--control"
                                            placeholder="City" name="city" value="{{ @$user->address->city }}">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="input--group textarea">
                                        <textarea id="address" class="form--control" placeholder="Address">@php echo@$user->address->address @endphp</textarea>
                                    </div>
                                </div>
                            </div>
