    ...
    <div class="body-wrapper">
        <div class="table-content">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-end">
                        <a href="{{ route('ticket') }}" class="btn--base btn-sm mb-2">@lang('My Support Ticket')</a>
                    </div>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input--group">
                                            <input type="email" class="form--control" id="email_adress"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <select id="Priority" name="priority" class="form-select select" required>
                                ...
                                <div class="col-sm-12 text-end">
                                    <button type="button" class="btn--base ms-2 addFile">
