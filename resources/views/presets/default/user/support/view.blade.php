...
@section('content')
    <div class="{{ auth()->user() ? 'body-wrapper' : 'container pt-120' }}">
                            ...
                            <div class="col-md-12">
                                <div class="view-ticket-head d-flex justify-content-between">
                                    ...
                                    @if ($myTicket->status != 3 && $myTicket->user)
                                        <button class="btn button bg-danger btn-suuport confirmationBtn border-0" type="button"
                            ...
                            @if ($myTicket->status != 4)
                                <form method="post" action="{{ route('ticket.reply', $myTicket->id) }}"
                                    ...
                                    <div class="col-sm-12 text-end">
                                        <button type="button" class="btn btn--base mt-3 addFile">
                                    ...
                                    <div class="col-sm-12 text-end">
                                        <button type="submit" class="btn--base"> <i class="fa fa-reply"></i>
                                            @lang('Reply')</button>
                                    </div>
                                </form>
                            @endif
