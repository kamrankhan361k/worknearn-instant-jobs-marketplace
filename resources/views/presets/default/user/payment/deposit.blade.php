                                ...
                                <div class="border-box user-profile">
                                    <form action="{{ route('user.deposit.insert') }}" method="post">
                                        ...
                                        <div class="dashboard-card-wrap">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" step="any" name="amount"
                                                        ...
                                                        value="{{ $job->total_budge ?? 0 }}" autocomplete="off"
                                                        required readonly>
                                                    <span class="input-group-text bg--base text-white b-none">{{ @$general->cur_text }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <button type="submit"
                                                class="btn--base button w-100 mt-3">@lang('Save')</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
